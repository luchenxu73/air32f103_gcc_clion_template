...
#define  RCC_CFGR_PLLMULL17                 ((uint32_t)0x10000000)        /*!< PLL input clock*17 */
#define  RCC_CFGR_PLLMULL18                 ((uint32_t)0x10040000)        /*!< PLL input clock*18 */
#define  RCC_CFGR_PLLMULL19                 ((uint32_t)0x10080000)        /*!< PLL input clock*19 */
#define  RCC_CFGR_PLLMULL20                 ((uint32_t)0x100C0000)        /*!< PLL input clock*20 */
#define  RCC_CFGR_PLLMULL21                 ((uint32_t)0x10100000)        /*!< PLL input clock*21 */
#define  RCC_CFGR_PLLMULL22                 ((uint32_t)0x10140000)        /*!< PLL input clock*22 */
#define  RCC_CFGR_PLLMULL23                 ((uint32_t)0x10180000)        /*!< PLL input clock*23 */
#define  RCC_CFGR_PLLMULL24                 ((uint32_t)0x101C0000)        /*!< PLL input clock*24 */
#define  RCC_CFGR_PLLMULL25                 ((uint32_t)0x10200000)        /*!< PLL input clock*25 */
#define  RCC_CFGR_PLLMULL26                 ((uint32_t)0x10240000)        /*!< PLL input clock*26 */
#define  RCC_CFGR_PLLMULL27                 ((uint32_t)0x10280000)        /*!< PLL input clock*27 */
#define  RCC_CFGR_PLLMULL28                 ((uint32_t)0x102C0000)        /*!< PLL input clock*28 */
#define  RCC_CFGR_PLLMULL29                 ((uint32_t)0x10300000)        /*!< PLL input clock*29 */
#define  RCC_CFGR_PLLMULL30                 ((uint32_t)0x10340000)        /*!< PLL input clock*30 */
#define  RCC_CFGR_PLLMULL31                 ((uint32_t)0x10380000)        /*!< PLL input clock*31 */
#define  RCC_CFGR_PLLMULL32                 ((uint32_t)0x103C0000)        /*!< PLL input clock*32 */
